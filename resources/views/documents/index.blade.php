<x-app-layout>
                            ...
                            <tbody class="divide-y divide-gray-50">
                                @forelse($documents as $doc)
                                    <tr class="hover:bg-gray-50/50 transition-colors group">
                                        ...
                                        <td class="py-5 px-4 text-center">
                                            <span class="inline-block px-3 py-1 bg-blue-50 text-blue-600 rounded-lg text-[11px] font-bold uppercase tracking-wide">
                                                {{ $doc->category->parent ? $doc->category->name : '-' }}
                                            </span>
                                        </td>
                                        <td class="py-5 px-4 text-center">
                                            <span class="inline-block px-2 py-1 bg-gray-100 text-gray-600 rounded text-[10px] font-bold uppercase">
                                                {{ $doc->file_type ?? '-' }}
                                            </span>
                                        </td>
                                        <td class="py-5 px-4 text-center">
                                            <span class="text-sm font-bold text-gray-700">{{ $doc->year }}</span>
                                        </td>
                                            ...
                                            <div x-data="{ open: false }" class="relative inline-block text-left">
                                                ...
                                                <div x-show="open" 
                                                    ...
                                                    <button type="button" 
                                                            ...
                                                            class="w-full flex items-center gap-3 px-4 py-2.5 text-sm font-semibold text-red-600 hover:bg-red-50 transition-colors text-left">
                                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg>
                                                        Hapus
                                                    </button>
                                                </div>
                                ...
                                @empty
                                    <tr><td colspan="7" class="py-20 text-center text-sm font-bold text-gray-300 uppercase tracking-widest">Data Tidak Ditemukan</td></tr>
                                @endforelse
                            </tbody>
                        </table>
                    </div>
    ...
    <script>
        ...
        function handleDeleteMultiple(selectedDocs) {
            ...
            // Bersihkan input lama buatan fungsi sebelumnya tanpa merusak token @csrf asli
            let oldInputs = form.querySelectorAll('input[name="ids[]"]');
            oldInputs.forEach(input => input.remove());
            
            // Buat input baru untuk ID yang dicentang
